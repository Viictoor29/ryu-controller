...
class MininetAPIService:
    ...
    def notify_ryu_forget_host(self, mac):
        ...
        safe_mac = urllib.parse.quote(str(mac), safe="")
        url = f"http://127.0.0.1:8080/api/hosts/forget/{safe_mac}"
        ...
        try:
            ...
            print(f"[mininet-api] No se pudo avisar a Ryu para olvidar {mac}: {e}")
            return None
