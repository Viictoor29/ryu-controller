...
from utils.responses import success_response, error_response, cors_preflight
from utils.validators import read_json_body, require_fields
...
class SDNRestController(ControllerBase):
    ...
    def disable_link(self, req, **kwargs):
        ...
        try:
            ...
            result = self.sdn_app.link_service.disable_link(body["src"], body["dst"])
    ...
    def enable_link(self, req, **kwargs):
        ...
        try:
            ...
            result = self.sdn_app.link_service.enable_link(body["src"], body["dst"])
            return success_response(result)
        except Exception as e:
    ...
    def set_link_loss(self, req, **kwargs):
        ...
        try:
            ...
            result = self.sdn_app.link_service.set_link_loss(body["src"], body["dst"], body["loss"])
            return success_response(result)
        except Exception as e:
    ...
    def set_link_bandwidth(self, req, **kwargs):
        ...
        try:
            ...
            result = self.sdn_app.link_service.set_link_bandwidth(body["src"], body["dst"], body["bandwidth"])
            return success_response(result)
        except Exception as e:
    ...
    def set_link_delay(self, req, **kwargs):
        ...
        try:
            ...
            result = self.sdn_app.link_service.set_link_delay(body["src"], body["dst"], body["delay"])
            return success_response(result)
        except Exception as e:
    ...
    def clear_link_tc(self, req, **kwargs):
        ...
        try:
            ...
            result = self.sdn_app.link_service.clear_link_tc(body["src"], body["dst"])
            return success_response(result)
        except Exception as e:
